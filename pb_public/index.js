...
import { db_authenticate, db_create_penguin, db_create_user, db_init, db_get_own_penguins } from "./db.js";
...
async function pick_penguin() {
  ...
  if (selection.index === penguinNames.length - 1) {
    ...
    let result = await db_create_penguin(creation);
